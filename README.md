...
- **Product (товар)**
  - **GET** `/api/v1/products` (Получить список товаров)
    ```json
    {
        "shop_type": "{shop_type}" // wildberries, ozon, ...
        "ids" : "406256148,91138231,..." // коды товаров с маркетплейса
    } 
...
- добавить redis. Хранить: магазины
...
- фильтрация продуктов по User, магазину, лимит при выводе
- добавить проверку headers
- фильтры из ProductProvider перенести в CurrentUserExtension